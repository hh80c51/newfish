...
//        Future<PaymentVO> paymentFuture = SingletonThreadPool.callCachedThreadPool(()-> finPaymentRecordService.findPaymentSum(channelCdt));
//        BigDecimal tonglianTodaySum = paymentFuture.get().getTransMoneySum();
    }
}
